  ...
  <div class="flex-grow bg-white dark:text-gray-100 dark:bg-gray-900">
    <div class="space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        <div v-for="(blog, ind) in blogs" :key="blog.id" class="animate-fade-in-down"  :style="{animationDelay: `${ind * 0.1}s`}">                      
          <img :src="blog.imageUrl" class="w-full h-60 object-cover">
    ...
    <footer id="page-footer" class="flex-none items-center bg-gradient-to-r from-gray-800 to-gray-900">
      <div class="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm container xl:max-w-7xl mx-auto px-4 lg:px-8">
        <div class="pt-4 pb-1 md:pb-4">
          <a href="#" class="font-semibold text-white hover:text-indigo-700 focus:outline-none" target="_blank">Gedoni Ani © 2024</a> 
        </div>
        <div class="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
          <a href="https://www.linkedin.com/in/gedonidev/" class="hover:text-indigo-700 text-white" target=_blank>
          ...
          <a href="https://github.com/gedons/" class="hover:text-indigo-700 text-white" target="_blank">
          ...
          <a href="https://twitter.com/AniGedoni" class="hover:text-indigo-700 text-white" target="_blank">
