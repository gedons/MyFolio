<template>
  ...
  <header id="home" class="bg-white mt-10">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
      ...
      <div class="flex items-center lg:justify-end text-blue-500">
        ...
        <img src="https://drive.google.com/file/d/1VvVXw5PECaDrn0oegp4oG14k91-AW9aP/view?usp=sharing" alt="Image" />
      </div>
    </div>
  </header>
  <!-- End Header -->
  ...
  <section id="portfolio" class="bg-gray-100">
    <div class="space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-4">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 opacity-0 animate-fade-in-down">
        <div v-for="(project, ind) in frontProject.data" :key="project.id" class="p-5 bg-white border-2 border-white shadow-sm hover:border-indigo-700 transition rounded-lg animate-fade-in-down"  :style="{animationDelay: `${ind * 0.1}s`}">            
 ...
 <!-- End Portfolio -->
  ...
  <button
   ...
   @click="scrollToTop"
   class="fixed bottom-20 right-20 border-none rounded-md" >
 ...
 <!-- End Scroll-to-Top Button  -->
  ...
  <!-- Contact Section -->
  <div id="contact" class="flex flex-col mx-auto w-full min-h-screen min-w-[320px] bg-gray-100">
    <!-- Page Content -->
